...
### Initial Setup
1. **Extracting Project Files**:
   The project files were extracted from a provided ZIP file to set up the project structure.

2. **Installing Dependencies**:
   Installed the necessary dependencies using npm:
   ```sh
   npm install
